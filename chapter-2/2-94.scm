...
; checked using https://www.symbolab.com/solver/polynomial-gcd-calculator
; this website's answer gave x^2-x whereas my solution gave -x^2+x

; actually these two results are negations of each other. both valid divisors.
; which one is greater would depend on whether x>1
; if x=1 they are equal

; this seems like more than just a coincidence that the authors gave this example!