...
I drew the diagrams using [LibreOffice Draw](https://www.libreoffice.org/discover/draw/) and provide the .odg files, although maybe something like [Mermaid](https://mermaid.js.org/) would be have been better.
